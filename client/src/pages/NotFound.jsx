  ...
  return (
    <div className="h-[calc(100vh-4rem)] flex flex-col items-center justify-center px-4">
      <div className="text-center">
        ...
        <p className="text-2xl mt-4 text-gray-600 sm:text-3xl">
          Page Not Found
        </p>
        ...
        <div className="mt-8">
          <button
            ...
            className="bg-green-500 hover:bg-green-700 text-white font-bold py-2 px-6 rounded sm:px-8 sm:py-3 sm:text-lg"
          >
            Go to Home
          </button>
        </div>
